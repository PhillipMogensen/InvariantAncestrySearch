...
new_labels = [r'$\hat{S}_{\operatorname{IAS}}$', r'$\hat{S}_{\operatorname{ICP}}$']
...
############################################################ Weak instruments ############################################################
db1 = shelve.open('output/finite_experiment/d_equal_6/alpha0_equal_10Eminus6_WeakInstrument')
data = db1['data']
objs = db1['objlist']
db1.close()
